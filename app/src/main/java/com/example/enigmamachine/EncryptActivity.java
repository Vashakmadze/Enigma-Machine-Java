...
public class EncryptActivity extends AppCompatActivity {
    ...
    public void keyPress(View v) {
        ...
        String afterPlug = outputPlugged(preInput);
        String firstRotorOutput = rotorFirst(afterPlug, firstRotorPosition);
        String secondRotorOutput = rotorSecond(firstRotorOutput, secondRotorPosition);
        String thirdRotorOutput = rotorLast(secondRotorOutput, thirdRotorPosition);
    ...
    public void output(String plugboard, String firstRotor, String secondRotor, String thirdRotor) {
        ...
        // output plug
        TextView outputPlugView = findViewById(R.id.output_plugboard_encrypt); // plugboard View
        ...
        // output firstRotor
        TextView outputFirstRotorView = findViewById(R.id.output_first_rotor_encrypt);
        ...
        // output secondRotor
        TextView outputSecondRotorView = findViewById(R.id.output_second_rotor_encrypt);
        ...
        //output thirdRotor
        TextView outputThirdRotor = findViewById(R.id.output_third_rotor_encrypt);
